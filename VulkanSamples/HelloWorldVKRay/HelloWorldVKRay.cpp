...
int main()
{
	std::shared_ptr<vksamples::common::legacy::vk::IContext> context_;
   ...
   // program, which can be useful for layers and tools to provide more debug information.
	...
	application_info.pApplicationName = "Vulkan Program Template";
	application_info.applicationVersion = 1;
	application_info.pEngineName = "LunarG SDK";
	application_info.engineVersion = 1;
	application_info.apiVersion = VK_API_VERSION_1_0;

	context_ = vksamples::common::legacy::vk::IContext::Create(application_info);
